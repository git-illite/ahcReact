...
import Background from "../Assets/280-masjid-AHC-dark-1920.png";

const Hero = () => {
  return (
    <div className="relative z-10 bg-white p-2 md:mb-28">
      {/* <!-- Content at the top of the container --> */}

      <section className="relative bg-bgr bg-cover bg-center bg-no-repeat h-176">
        <div className="absolute inset-0 bg-white/75 sm:bg-transparent sm:from-white/95 sm:to-white/25 ltr:sm:bg-gradient-to-r rtl:sm:bg-gradient-to-l"></div>

        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 flex justify-center items-center">
        ...
        <div className="absolute bottom-0 w-full flex flex-wrap justify-start mb-8 px--2">
          {/* Cards container */}
          <div className="absolute bottom-0 md:w-full md:flex md:justify-center md:-mb-32 grid-cols-1 md:grid-cols-5 lg:grid-cols-5 lg:gap-8 ">
            {/* Individual card */}
            <div className="bg-slate-100 p-4 shadow-lg md:h-32 md:w-98">
